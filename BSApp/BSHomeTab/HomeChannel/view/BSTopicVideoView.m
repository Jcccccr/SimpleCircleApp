...
- (UIButton *)playIcon
{
    if (!_playIcon)
    {
        ...
        [_playIcon setBackgroundImage:[UIImage imageNamed:@"video-play"] forState:UIControlStateNormal];
...
- (void)setModel:(BSHomeTopicsModel *)model
{
    ...
    NSString *urlStr = model.videouri;
...
- (void)clickToPlay
{
    ...
    {
        self.playVideoBlock(_model.videouri);
    }
}
